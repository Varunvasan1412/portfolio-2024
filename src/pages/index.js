          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center ">
              <AnimatedText
                ...
                className="!text-6xl !text-left xl:!5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl "
              />
              <p className="py-3 text-base font-medium md:text-sm sm:text-xs">
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  ...
                  target={"_blank"}
                  className="flex items-center dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold
